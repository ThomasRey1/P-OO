...
namespace X_P_OO_Tests_Unitaires_Thomas_Alexandre
{
    ...
    public class UnitTest1
    {
        ...
        public void IsResearchCountGood()
        {
            ...
            Label lblresult = indexing.lblNumberResults;
            ...
            //act (code de test)
            ModelResearch research = new ModelResearch();

            //assert (renvoi du résultat)
            Assert.AreEqual(/*résultat attendu*/3, /*résultat actuel*/research.Search("", "*", lblresult).Count, /*string expliquant le résultat attendu*/"nombre d'éléments dans la liste = 3");
        }
        ...
        public void IsResearchFileNameGood()
        {
            ...
            //act (code de test)
            ModelResearch research = new ModelResearch();
            result = research.Search("", "*", lblresult);
